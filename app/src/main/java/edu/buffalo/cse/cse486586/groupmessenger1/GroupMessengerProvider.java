...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
         ...
         */
        //Fetch values from ContentResolver and write to internal storage
        try {
    ...
    public boolean onCreate() {
        ...
        URI_builder.authority("edu.buffalo.cse.cse486586.groupmessenger1.provider");
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
         ...
         */
        //Retrieve information from internal storage using selection provided as the filename and prepare a MatrixCursor object with the data fetched
        try {
